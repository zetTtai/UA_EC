#Añade al código anterior la posibilidad de leer un valor n por teclado y escribe el
#resultado de la suma por consola. Haz que haya un bucle infinito que lea por
